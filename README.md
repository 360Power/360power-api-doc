...
Once given your access token, you can use our open-source testing utility to check the validity and usability of your access token. Check it out at [BigerFX](https://github.com/biger-exchange/biger-fx)
